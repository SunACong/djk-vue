<template>
  <div class="layout-body">
    ...
    <div class="mid-process">
      ...
      <el-button type="primary" style="margin-left: 15px" @click="getSelectValueAndType(selectValue, 2)">搜索</el-button>
    </div>
    <custom-step-2 :steps-data="stepData" :active="active" @active="getActive" :status="status"/>
    </div>

    <div class="bottom-form" v-show="showForm">
...
<script>
import CustomStep2 from '@/views/dashboard/CustomStep2'
...
FormMap.set(0, 'erpPlanColdreductionstrip')
FormMap.set(1, 'lmdpColdRecord')
FormMap.set(2, 'lmdpColdFurnaceRecord')
FormMap.set(3, 'lmdpColdRereelerRecord')
FormMap.set(4, 'lmdpQcColdReelReport')
FormMap.set(5, 'lmdpColdStoreRecord')
export default {
  name: 'ProcessMonitor',
  components: {
    CustomStep2
  ...
  data() {
    return {
      formJson: [formJson6, formJson7, formJson8, formJson9, formJson12,
        formJson10,formJson0, formJson1, formJson2, formJson3, formJson4, formJson5,
         formJson13],
      active: -2,
      current: null,
      status: [],
