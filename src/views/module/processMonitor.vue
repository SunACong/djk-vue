  ...
  <div class="app-container" style="background-color: white">
    ...
    <div>
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="铸轧生产计划详细信息">
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="出入库记录（铸轧）工序详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
                :data="zhuzhaChuRu"
                style="width: 100%">
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="铸轧卷质检报告序详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="冷轧生产计划工序详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
                :data="lenzhascjhData"
                style="width: 100%">
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="出入库记录（冷轧）工序详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
                :data="lenzharukuData"
                style="width: 100%">
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="冷轧工序质量巡检详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="冷轧卷质检报告工序详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        <el-collapse-item title="投诉及处理信息详细信息">
          <div style="background-color: white;padding: 10px 10px">
            <el-table
                :data="complaintData"
                style="width: 100%">
