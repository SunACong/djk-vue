<template>
	<div class="app-container">
		<div style="display: flex;">
			...
			<el-input v-model="input" style="line-height: 10px; width:200px" size="mini" placeholder="请输入你要查询的生产流程">
			</el-input>
			<el-row>
			...
			<div class="top_card">
				<el-card shadow="always" style="height: 500px">
					<div slot="header" style="line-height: 40px;display: flex;justify-content: space-between;">
						<div style="display: flex;">
							<div style="font-size: 20px;color: blue;margin-right: 3px;"><i class="el-icon-s-help" />
							</div>
	...
	export default {
		...
		data() {
			return {
				...
				stepData: [{
						title: '步骤1铸扎生产计划确定',
						description: '生产计划编号：A123456，创建人：张三，订单评审编号 ：A1111111，合金状态：良好。'
					},
					{
						title: '步骤2熔炉生产',
						description: '生产线号：A20220402生产地点：丹江口，熔炉状态：正常，牌号：B123456'
					},
					{
						title: '步骤3保温',
						description: '保温时间：2022.04.02，牌号：A123456，取样时间：2022.05012，取样温度：88度，保温地点：丹江口， 精炼间隔时间：10小时，'
					},
					{
						title: '步骤4铸扎生产',
						description: '生产时间：2022.04.02生产地点：丹江口，熔炉状态：正常，铸轧卷号：A123456,除气箱参数设定值#炉气温度℃:500度，除气箱参数设定值#铝液温度℃：700度'
					},
					{
						title: '步骤5铸扎卷质检',
						description: '检查时间：2022.04.02检察地点：丹江口，检查人：李四， 轧辊编号：A144777'
					},
					{
						title: '步骤6铸扎卷入库',
						description: '入库时间：2022.04.02入库地点：丹江口，入库人员：李四，轧辊编号：A144777'
					},
					{
						title: '步骤7冷轧生产计划确定',
						description: '确定时间：2022.04.02生产地点：丹江口，，轧辊编号：A144777'
					},
					{
						title: '步骤8冷轧生产',
						description: '生产时间：2022.04.02生产地点：丹江口'
					},
					{
						title: '步骤9第1道次轧制',
						description: '轧制时间：2022.04.02轧制地点：丹江口，熔炉状态：正常，，轧辊编号：A144777'
					},
					{
						title: '步骤10第2道次轧制',
						description: '轧制时间：2022.04.02轧制地点：丹江口，熔炉状态：正常，，轧辊编号：A144777'
					...
					{
						title: '步骤11退火',
						description: '退火时间：2022.04.02熔炉状态：正常'
					},
					{
						title: '步骤11退火',
						description: ' 退火时间：2022.04.02熔炉状态：正常，冷轧卷号：A123456，退火开始时间：2022.04.02，退火结束时间：2022.05.02，炉气温度(℃)Ⅰ区：800度'
					},
					{
						title: '步骤12第3道次轧制',
						description: '轧制时间：2022.04.02轧制地点：丹江口，熔炉状态：正常'
					},
					{
						title: '步骤13第1次退火',
						description: '退火时间：2022.04.02退火地点：丹江口，熔炉状态：正常，退火开始时间：2022.04.02，退火结束时间：2022.05.02，炉气温度(℃)Ⅰ区：800度'
					},
					{
						title: '步骤14第4道次轧制',
						description: '轧制时间：2022.04.02轧制地点：丹江口，熔炉状态：正常'
					...
					{
						title: '步骤18冷轧卷成品质检',
						description: '质检时间：2022.04.02质检地点：丹江口，质检人员：李四'
					},
					{
						title: '步骤19冷轧卷成品入库',
						description: '入库时间：2022.04.02入库地点：丹江口，入库人员：李四'
					},
					{
						title: '步骤20重卷中切',
						description: '时间：2022.04.02地点：丹江口，熔炉状态：正常'
					},
					{
						title: '步骤21包装检验',
						description: '检验时间：2022.04.02检验地点：丹江口，冷轧卷号：A1234567，合格证：有/无，产品证书：编号XXXXXXX,包装日期:2022.05.02'
					}
				],
				yichangAlign: {},
				fengxianAlign: {},
