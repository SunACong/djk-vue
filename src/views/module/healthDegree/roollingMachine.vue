...
import {getListInfo,getListWarnData} from "@/api/rollingMachine";
...
export default {
  ...
  async created() {
    ...
    // await getListWarnData({rollingName : '上辊电机电流',maxValue : 70}).then((res) => {
    //   this.loading=true
    ...
    setTimer() {
      if(this.timer == null) {
        this.timer = setInterval( () => {
          ...
          getListInfo({rollingName : '下辊电机电流'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '主水泵电机电流'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '备用水泵电机电流'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '卷取电机电流'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '上辊水压'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '下辊水压'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '上辊水温'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '下辊水温'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '上辊流量'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '下辊流量'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '操作侧预载力'}).then((res) =>{
            this.dataList = res.data
          ...
          getListInfo({rollingName : '传动侧预载力'}).then((res) =>{
            this.dataList = res.data
