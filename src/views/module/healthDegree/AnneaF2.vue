    ...
    <div>
                ...
                <el-card shadow="always">
                    <div slot="header" style="line-height: 20px;display: flex;justify-content: space-between;">
                        <div style="display: flex;">
                            ...
                            <span style="line-height: 20px;">2#退火炉参数</span>
                        </div>
                    </div>
                    <div>
        ...
        <div class="health_status" style="margin-top: 8px">
            <el-card shadow="always">
                ...
                <div>
                    <el-table :data="currentWarnTable" stripe style="width: 100%,display: flex;" height="300px"
                        :show-header="true">
        ...
        <div class="health_status" style="margin-top: 8px">
            <el-card shadow="always">
                ...
                <div style="display: flex;">
                    <div>
                        <el-date-picker v-model="qualifyDateRange" size="medium" type="datetimerange" align="left"
                            unlink-panels range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"
                            :picker-options="pickerOptions" @change="getDate" />
                    </div>
                    <template>
                ...
                <div>
                    <el-table :data="historyWarnTable" stripe style="width: 100%,display: flex;" height="300px"
                        :show-header="true">
                        <!-- <el-table-column prop="idNumber" label="序号" /> -->
                        <el-table-column prop="rollingProduceTime" label="日期" />
                        <el-table-column prop="rollingName" label="指标名称" />
...
import { getListNewData2, getListSpecial2, rollingOptions, rollingTableData1 } from '@/api/AnneaF'
...
export default {
    ...
    async created() {
         ...
         * 获取一号铸轧机报警历史记录（30条）
         */
        // await getListWarnHistoryData({ rollingDeviceNumber: '退火炉2#' }).then((res) => {
        //     this.historyWarnTable = res.data
        // })
        //退火炉2实时记录
        await getDevice({ rollingDeviceNumber: '退火炉2#' }).then((res) => {
    ...
    methods: {
        ...
        getMyHistoryData: function () {
            ...
            getListDuringWarnData({ rollingDeviceNumber: '退火炉2#', rollingName: this.indicatorName, begin: this.begin, end: this.end }).then((res) => {
        ...
        getMyData: function (index, row) {
             ...
             */
                ...
                getListSpecial2({ rollingName: row.rollingName, ts: row.rollingProduceTime }).then((res) => {
            ...
            if (this.timer == null) {
                this.timer = setInterval(() => {
                    ...
                    getListNewData2().then((res) => {
                        ...
                        } else if (res.data[0].compressedAirOneLowPressure == 1) {
                    ...
                    // 定时查询退火炉最新20条报警记录
                    getDevice({ rollingDeviceNumber: '退火炉2#' }).then((res) => {
                        this.currentWarnTable = res.data
                    })
                }, 3500)
            }
