      ...
      if (this.timer == null) {
        this.timer = setInterval(() => {
          ...
          getListNewData().then((res) => {
            ...
            this.rollingTableData3[12].chartData.rType = []
            ...
            this.dataList.forEach(item => {
              ...
              this.rollingTableData3[2].chartData.rType = 'upRollMontorA'
              ...
              this.rollingTableData3[3].chartData.rType = 'upRollMontorA'
              ...
              this.rollingTableData3[4].chartData.rType = 'rollA'
              ...
              this.rollingTableData3[5].chartData.rType = 'upRollWaterFn'
              ...
              this.rollingTableData3[6].chartData.rType = 'downRollWaterFn'
              ...
              this.rollingTableData3[7].chartData.rType = 'upRollWaterT'
              ...
              this.rollingTableData3[8].chartData.rType = 'downRollWaterT'
              // this.rollingTableData3[].chartData.rType = ""
              ...
              this.rollingTableData3[9].chartData.rType = 'upRollFlow'
              ...
              this.rollingTableData3[10].chartData.rType = 'downRollFlow'
              ...
              this.rollingTableData3[11].chartData.rType = 'operationPreloadForce'

              this.rollingTableData3[12].chartData.xData.push(item.ts)
              this.rollingTableData3[12].chartData.yData.push(item.transPreloadForce)
              this.rollingTableData3[12].chartData.rName = '传动侧预载力'
              this.rollingTableData3[12].chartData.rType = 'transPreloadForce'
              // 上辊电机电流
