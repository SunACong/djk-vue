...
import {getListInfo,getListSpecial,rollingTableData4} from "@/api/rollingMachine";
        ...
        this.timer = setInterval( () => {
          ...
          getListInfo({rollingName : '上辊电机电流',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[0].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊电机电流',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[1].chartData.maxData){
          ...
          getListInfo({rollingName : '主水泵电机电流',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[2].chartData.maxData){
          ...
          getListInfo({rollingName : '备用水泵电机电流',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[3].chartData.maxData){
          ...
          getListInfo({rollingName : '卷取电机电流',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[4].chartData.maxData){
          ...
          getListInfo({rollingName : '上辊水压',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[5].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊水压',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[6].chartData.maxData){
          ...
          getListInfo({rollingName : '上辊水温',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[7].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊水温',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[8].chartData.maxData){
          ...
          getListInfo({rollingName : '上辊流量',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[9].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊流量',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[10].chartData.maxData){
          ...
          getListInfo({rollingName : '操作侧预载力',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[11].chartData.maxData){
          ...
          getListInfo({rollingName : '传动侧预载力',rollingDeviceId:4}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData4[12].chartData.maxData){
