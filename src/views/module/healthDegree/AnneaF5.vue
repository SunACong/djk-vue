...
export default {
  ...
  methods: {
    ...
    getengineList() {
      ...
      //       退火炉4#
      // select * from t_4085e170a62511ed8b62ff846936488a where ts > now - 5s;
      var zong = 'SELECT * FROM t_4085e170a62511ed8b62ff846936488a where ts between'
    ...
    getMyHistoryData: function () {
      ...
      getListDuringWarnData({ rollingDeviceNumber: '退火炉4#', rollingName: this.indicatorName, begin: this.begin, end: this.end }).then((res) => {
