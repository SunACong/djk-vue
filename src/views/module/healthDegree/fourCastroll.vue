        ...
        this.timer = setInterval( () => {
          ...
          getListNewData().then((res) =>{
            ...
            this.dataList.forEach(item =>{
              ...
              this.rollingTableData4[12].chartData.xData.push(item.createTime)
