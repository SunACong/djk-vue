...
import {getListInfo,getListSpecial,rollingTableData3} from "@/api/rollingMachine";
        ...
        this.timer = setInterval( () => {
          ...
          getListInfo({rollingName : '上辊电机电流',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[0].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊电机电流',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[1].chartData.maxData){
          ...
          getListInfo({rollingName : '主水泵电机电流',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[2].chartData.maxData){
          ...
          getListInfo({rollingName : '备用水泵电机电流',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[3].chartData.maxData){
          ...
          getListInfo({rollingName : '卷取电机电流',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[4].chartData.maxData){
          ...
          getListInfo({rollingName : '上辊水压',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[5].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊水压',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[6].chartData.maxData){
          ...
          getListInfo({rollingName : '上辊水温',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[7].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊水温',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[8].chartData.maxData){
          ...
          getListInfo({rollingName : '上辊流量',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[9].chartData.maxData){
          ...
          getListInfo({rollingName : '下辊流量',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[10].chartData.maxData){
          ...
          getListInfo({rollingName : '操作侧预载力',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[11].chartData.maxData){
          ...
          getListInfo({rollingName : '传动侧预载力',rollingDeviceId:3}).then((res) =>{
            ...
            this.dataList.forEach(item =>{
              if(item.rollingValue>this.rollingTableData3[12].chartData.maxData){
