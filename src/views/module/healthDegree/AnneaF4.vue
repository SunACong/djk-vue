        ...
        <el-card shadow="always">
          <div slot="header" style="line-height: 20px;display: flex;justify-content: space-between;">
            <div style="display: flex;">
              ...
              <span style="line-height: 20px;">4#退火炉参数</span>
            </div>
          </div>
          <div>
...
import { getListNewData4, getListSpecial4, rollingOptions, rollingTableData1 } from '@/api/AnneaF'
  ...
  methods: {
    ...
    getMyData: function (index, row) {
       ...
       */
        ...
        getListSpecial4({ rollingName: row.rollingName, ts: row.rollingProduceTime }).then((res) => {
