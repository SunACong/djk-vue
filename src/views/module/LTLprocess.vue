  ...
  <div>
    ...
    <div style="background-color: white;padding: 20px 10px">
      <el-input v-model="queryParams.batchNum" size="small" placeholder="请输入计划单号/请输入熔次号/请输入冷轧卷号" :clearable="true" >
        <el-button slot="append"	style="background-color: #46b9b9;color: white;line-height: 15px;" size="small" @click="query(queryParams.batchNum)">
          查询
        </el-button>
      </el-input>
      <div align="center">
    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item title="冷轧工序详细信息">
        <div style="background-color: white;padding: 10px 10px">
          <el-table
    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item title="退火工序详细信息">
        <div style="background-color: white;padding: 10px 10px">
          <el-table
              :data="tuihuoData"
              style="width: 100%">
    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item title="重卷工序详细信息">
        <div style="background-color: white;padding: 10px 10px">
          <el-table
              :data="rewindData"
              style="width: 100%">
...
import { getColdFurnaceRecordList, getLenzhaTimeList } from '@/api/ImdpColdFurnaceRecord'
...
export default {
  ...
  methods: {
    ...
    async getDoubleLineData() {
      var temp = []
      var tempTime = []
      const { data } = await getLenzhaTimeList()
      console.log('这是冷轧的数据', data)
      for (const item of data) {
        temp.push(item.gas_temperature1)
